        ...
        <div style={mh.overlay} onClick={() => setOpen(false)}>
          <div style={mh.drawer} onClick={e => e.stopPropagation()}>
            <div style={mh.drawerProfile}>
              ...
              <span style={mh.drawerSubtitle}>Electrical Engineering Undergraduate @ UCF</span>
            </div>
...
const mh = {
  ...
  drawerSubtitle: { fontFamily: "'JetBrains Mono',monospace", fontSize: 10, color: '#1B3A5C', letterSpacing: '0.02em', lineHeight: 1.6, marginTop: 2, textAlign: 'center' },
};
    ...
    <div style={hf.aboutRow}>
      <div style={{ ...hf.aboutText, marginLeft: isMobile ? 0 : 114 }}>
        ...
        <p style={hf.aboutBio}>
          ...
          theme park enthusiast, I love exploring the parks with my mom, and I try to catch a round of
          golf with my dad whenever possible. On campus at UCF, I stay highly engaged through
          organizations like IEEE and the IEEE HKN honor society. When I'm not studying or spending time
          with family, you can usually find me reading up on the latest tech developments. Here's a
          glimpse into how I spend my free time:
        </p>
      </div>
      <AboutPhoto />
    </div>
...
const EXPERIENCE_DATA = [
  {
    ...
    summary: "During the summer of 2026, I interned at Lockheed Martin's Rotary and Mission Systems (RMS) facility in Moorestown, NJ, where I contributed to multiple projects that significantly expanded my technical skillset. One major project involved programming an RF safety system designed to protect personnel from microwave radiation. Because the site primarily develops phased array radars and conducts near- and far-field range testing, this was a critical safety measure. By reverse-engineering an outdated Field Programmable Gate Array (FPGA) logic unit, I helped implement a new embedded device to mimic its behavior and accurately measure external power levels. Beyond the RF safety system, I helped develop Test Readiness Reviews (TRRs) and Acceptance Test Plans (ATPs) for S-band phased array antennas. This challenged my understanding of system calibration and RF principles, allowing me to grasp the architecture of Active Electronically Scanned Arrays (AESAs) and the integration of DOORS requirements. Throughout the summer, I collaborated with various teams to troubleshoot hardware-level issues, diving deep into my embedded software programming skills.",
  ...
  },
  {
    ...
    summary: 'For two years, spanning my freshman through junior years, I worked in a production environment focused on various optical detection sensors. This setting provided hands-on experience with test documentation and processing using systems like Windchill. During this time, I authored hardware troubleshooting documents for Electronics Test Specialists, which were ultimately approved and integrated into the system. I also received professional CAD training in SolidWorks to model and develop test fixtures, and I assisted in managing a large inventory of electronic test hardware using IndySoft. Ultimately, this role challenged me and fostered my professional growth as I collaborated with a team to resolve complex documentation and hardware issues.',
...
const LEADERSHIP_DATA = [
  { id: 'ieee-hkn',           title: 'IEEE HKN Zeta Chi Chapter Vice President', date: 'Apr 2026 – Present',  thumb: 'assets/photos/hkn-1.jpg',                org: { logo: 'assets/photos/hkn-logo.png', name: 'IEEE-HKN' },              desc: "I currently serve as Vice President of the Zeta Chi chapter of IEEE Eta Kappa Nu (HKN), the international honor society for electrical and computer engineering. Since joining the organization, and previously serving as a chapter officer, I have helped organize three induction ceremonies and revamped the chapter's overall structure. Because the chapter went dormant during the COVID-19 pandemic, my primary mission has been to rebuild its foundation, ensure long-term sustainability, and restore the prestige that IEEE HKN holds at UCF.", skills: LEADERSHIP_SOFT_SKILLS },
  { id: 'ieee-president',     title: 'IEEE UCF President',                      date: 'Apr 2025 – Apr 2026', thumb: 'assets/photos/president-1.jpg',          org: { logo: 'assets/ieee_ucf_logo.jpg', name: 'IEEE UCF' },                 desc: 'During my junior year, I led the IEEE UCF student branch as Chair and President, an experience akin to running a small company. Throughout my tenure, I had the privilege of managing a 13-officer board, with each member specializing in different tasks and disciplines. Through regular meetings and tireless communication, our team orchestrated an academic year that educated, served, and provided valuable resources to students interested in electrical and computer engineering. Stepping into this role pushed me far outside my comfort zone, resulting in significant personal growth and teaching me exactly who I am and the kind of leader I want to be.', skills: LEADERSHIP_SOFT_SKILLS },
...
const PHOTO_MAP = {
  'ieee-president':      [{ src: 'assets/photos/president-1.jpg', caption: 'IEEE UCF Recruiting Event – Spring 2026' },{ src: 'assets/photos/president-2.jpg', caption: 'IEEE General Body Meeting 1 with AMD Panel – Spring 2026' },{ src: 'assets/photos/president-3.jpg', caption: 'IEEE x ACM Family Feud Event (I had the honor to dress up as Steve Harvey) – Fall 2025' },{ src: 'assets/photos/president-workshop-helping.jpg', caption: 'Helping Out at a Basic Breadboarding Workshop – Fall 2025' }],
  'ieee-project-chair':  [{ src: 'assets/photos/project-chair-header.jpg', caption: 'Presenting the IEEE UCF Project Lineup at a General Body Meeting – Fall 2024' },{ src: 'assets/photos/project-chair-photo2.jpg', caption: 'IEEE UCF 2024-25 Officer Board – Spring 2024' }],
  'ieee-hkn':            [{ src: 'assets/photos/hkn-1.jpg', caption: 'IEEE HKN Induction Ceremony – Spring 2026' },{ src: 'assets/photos/hkn-2.jpg', caption: 'IEEE HKN Induction Committee & Chapter Officers – Spring 2026' },{ src: 'assets/photos/hkn-3.jpg', caption: 'Me with HKN Logo at the Induction Ceremony – Spring 2026' },{ src: 'assets/photos/hkn-spring-inductees-2.jpg', caption: 'Earlier Induction Ceremony During the Spring – Spring 2026' },{ src: 'assets/photos/hkn-founders-day.jpg', caption: 'Founders Day Picture – Fall 2026' }],
  'ieee-service':        [{ src: 'assets/photos/service-committee-1.jpg', caption: 'Orlando Science Middle School Motor Workshop – Spring 2024' },{ src: 'assets/photos/service-committee-2.jpg', caption: 'Beach Cleanup Day – Spring 2024' },{ src: 'assets/photos/service-committee-3.jpg', caption: 'FIRST Robotics Event – Spring 2024' },{ src: 'assets/photos/service-committee-4.jpg', caption: 'E-Week 2024 Static Electricity Workshop – Spring 2024' }],
  'circuit-comp':        [{ src: 'assets/photos/circuit-design-competition-1.jpg', caption: 'Competition Setup – Spring 2026' },{ src: 'assets/photos/circuit-design-competition-2.jpg', caption: 'Circuit Under Test – Spring 2026' },{ src: 'assets/photos/circuit-design-competition-3.jpg', caption: '2nd Place Award – Spring 2026' }],
  'internal-project-comp': [{ src: 'assets/photos/internal-project-kicad-workshop.jpg', caption: 'KiCad Workshop – Fall 2024' },{ src: 'assets/photos/internal-project-tinkercad-workshop.jpg', caption: 'TinkerCAD Workshop – Fall 2024' },{ src: 'assets/photos/internal-project-kicad-workshop-ending.jpg', caption: 'KiCad Workshop Wrap-Up – Fall 2024' },{ src: 'assets/photos/internal-project-microcontroller-workshop.jpg', caption: 'Microcontroller Workshop – Fall 2024' },{ src: 'assets/photos/internal-project-batmobile-group.jpg', caption: 'Batmobile Project Group – Spring 2025' },{ src: 'assets/photos/internal-project-racecar-group.jpg', caption: 'Race Car Project Group – Spring 2025' },{ src: 'assets/photos/internal-project-batmobile-group-2.jpg', caption: 'Batmobile Project Group System Setup – Spring 2025' },{ src: 'assets/photos/internal-project-3d-printed-awards.jpg', caption: '3D-Printed Awards I Designed for Awardees of Beginner and Advanced Tracks – Spring 2025' }],
  'senior-design':       [{ src: 'assets/photos/senior-design-nasa.jpg', caption: 'NASA' }],
  ...
  'cwep':                [{ src: 'assets/photos/cwep-aircraft-sensor.gif', caption: 'The Microelectronics Center (MEC) and Sensors Test and Integration Center (SITC) Focused on Optical Detection Applications as Shown Above' }],
